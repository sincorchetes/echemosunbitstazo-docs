...
Este switch funciona cuando ejecutemos el comando `service check_nfs_working start|status|restart`, el parámetro recibido. :code:` ` **¡No olvides asignarle permisos de ejecución!**
